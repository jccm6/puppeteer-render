...
const scrapeLogic = async (res) => {
	const browser = await puppeteer.launch({
		args: [`--proxy-server=${process.env.SCRAPERAPI_URI}, --disable-features=site-per-process`, "--ignore-certificate-errors", "--disable-setuid-sandbox", "--no-sandbox", "--single-process", "--no-zygote"],
